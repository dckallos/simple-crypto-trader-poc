...
class GPTManager:
    ...
    def generate_multi_trade_decision(
        ...
        system_instructions = (
            ...
            f"RISK REQUIREMENTS:\n"
            f"1. You must never have much more than a 25% share in a single coin, with regard to the total available USD available.\n"
            f"2. If you do have much more than a 25% share in a single coin, you must sell the excess amount immediately.\n"
            f"3. You should make it a priority to have some level of diversity in active coins at any time.\n\n"
            "EXAMPLE:\n"
